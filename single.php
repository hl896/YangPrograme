...
$_SESSION['login_name']=$login_session;
                                ...
                                <div class="banner-bottom-grids">
                                    ...
                                    <div class="col-md-8 banner-bottom-left">
                                        ...
                                        <div class="post">
                                            ...
                                            <div class="post-grids">
                                                <div class="col-md-4 post-left">
                                                    <a href="single.php"><img src="images/pic1.jpg" alt="" /></a>
                                                </div>
                                            ...
                                            <div class="col-md-4 post-grids-1">
                                                <div class="post-left1">
                                                    <a href="single.php"><img src="images/pic6.jpg" class="img-responsive" alt="" /></a>
                                                </div>
                                                <div class="post-right1">
                                                    <h4><a href="#">Fly Fishers Serving as Transports for Noxious Little Invaders</a></h4>
                                                </div>
                                        ...
                                        <div class="respond">
                                            ...
                                            <form method="post" action="comments_post.php">
                                                <div id="name">
                                                    <p id="Name" name="<?php echo $login_session; ?>">Name:<i><?php echo $login_session; ?></i></p><br>
                                                </div>

                                                <textarea name="comments_contents" placeholder="Message" required></textarea>

                                                <input type="submit" name="submits" value="Submit Comment">
                                            ...
                                            <form>
                                                ...
                                                <div name="comments_area" class="comments_area_style">
                                                    <h4>All comments</h4>
                                                    <p><?php
                                                        $i_cal=0;
                                                        $querys="select emailadd, comment_Content from comment_table";
                                                            ...
                                                            while($rows=mysqli_fetch_array($result)){
                                                                ...
                                                                if(($i_cal%2)==0){
                                                                    ...
                                                                    echo '<div class="Title_header">UserID:'.$rows["emailadd"].'</div>';

                                                                    echo '<div id="oddID" class="odd_comment"> Comments: '.$rows["comment_Content"].'</div>';


                                                                }else{
                                                                    echo '<div class="Title_header">UserID: '.$rows["emailadd"].'</div>';
                                                                    echo '<div id="evenID" class="even_comment">Comments: '.$rows["comment_Content"].' </div>';
                                    ...
                                    <div class="col-md-4 banner-bottom-right">
                                        <div class="banner-bottom-left-grids">
                                            ...
                                            <div class="lor-ip">
                                                <div class="lor-ip">
                                                    <div class="fb-like-box" data-href="https://www.facebook.com/网页模板" data-width="240" data-height="270" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="true"></div>
                                                    <div id="fb-root"></div>
