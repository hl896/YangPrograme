                        ...
                        <div class="banner-grids">
                            ...
                            <div class="ban-top">
                                ...
                                <div class="col-md-6 bann-right">
                                    ...
                                    <h2><a href="single.php">Fly Fishers Serving as Transports for Noxious Little Invaders</a></h2>
                                    <p class="text">Lorem ipsum ex vix illud nonummy, novum tation et his. At vix scripta patrioque scribentur, at pro fugit verterem molestiae, sed et vivendo ali Lorem ipsum ex vix illud nonummy, novum tation et his. At vix scripta patrioque scribentur...</p>
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                                    ...
                                    <div class="banner-bottom-left">
                                        <div class="banner-bottom-left-grids">
                                            <div class="col-md-4 banner-left-grid fullwidth-left-grid">
                                                <h3>Valley Shows</h3>
                                                <a href="single.php"><img src="images/pic2.jpg" alt="" /></a>
                                            ...
                                            <div class="col-md-4 banner-left-grid fullwidth-left-grid">
                                                <h3>Novum tation</h3>
                                                <a href="single.php"><img src="images/pic4.jpg" alt="" /></a>
                                                <h4><a href="single.php">Silicon Valley Shows Signs of Dot-Com Frenzy</a></h4>
                                                <p class="comments">August 4 2010, <a href="#">8 Comments</a></p>
                                                <p class="text">Lorem ipsum ex vix illud nonummy, novum tation et his. At vix scripta patrioque scribentur...</p>
                                                <div class="blog-grids">
                                            ...
                                            <div class="col-md-4 banner-left-grid fullwidth-left-grid">
                                                <h3>Tation et</h3>
                                                <a href="single.php"><img src="images/pic6.jpg" alt="" /></a>
                                                <h4><a href="single.php">Silicon Valley Shows Signs of Dot-Com Frenzy</a></h4>
                                                <p class="comments">August 4 2010, <a href="#">8 Comments</a></p>
                                                <p class="text">Lorem ipsum ex vix illud nonummy, novum tation et his. At vix scripta patrioque scribentur...</p>
                                                <div class="blog-grids">
